...
import {Collapse, Descriptions, Divider, message, Modal, Popover, Select, Spin} from "antd";
...
import {backAttributes, frontAttributes,} from "../../components/muscles/muscles.ts";
                          ...
                          {detail?.additional_field.length !== 0
                            ...
                            : ""}
                                    ...
                                    <Collapse.Panel header="Show Additional Fields" key="1" className="font-semibold">
                                        <Descriptions column={2} size="small" bordered>
                                            {detail.additional_field.map((field, index) => (
                                                <Descriptions.Item key={index} label={field.key}
                                                                   style={{fontSize: '12px'}}>
                                                    {field.value}
                                                </Descriptions.Item>
                                            ))}
                                ...
                                <div className="flex items-center space-x-10 pl-8 pt-3">
                                    ...
                                    <button
                                        className="text-white bg-[#555555] font-bold border-2 border-[#565656] rounded w-[170px] pl-10 pr-10 pt-3 pb-3">
